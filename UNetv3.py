...
class UNet(nn.Module):
    ...
    def save_pretrained(self, pretrained_path: str, global_step=None) -> None:
        ...
        # Optionally, if you want to save global_step information:
        if global_step is not None:
            with open(os.path.join(pretrained_path, "global_step.txt"), "w") as f:
...
#summary(UNet(UNetConfig()), input_size=((1, 3, 32, 3
